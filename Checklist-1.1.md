...
|--------|--------|
| ❌     | Not Done/Missing |
| ⚠️     | Unofficial Port/Workaround |
| ✅     | Complete/Official Support |

## 1.1+ Compatible Mods (0.38)
...
| 3 Mods | [Surfpup](https://forums.terraria.org/index.php?members/surfpup.21475/) | 0.38 | ❌ | ✅ | ❌ | ❌ | Examples for Tiles is disable |
| 12 Mods | [W1K](https://forums.terraria.org/index.php?members/w1k.49/) | 0.38 | ❌ | ✅ | ❌ | ❌ | Hunger System, Difficulty Changer and more |
...
| ChadPack - Magic Mod (broken) | Chadwick (broken) | 0.34.1b | ❌ | ❌ | ❌ | ❌ | A themed minimod that adds some magicrelated stuff to the game. |
| ChadPack - Nipponjin/Japanese Mod (broken) | Chadwick (broken) | 0.34.1b | ❌ | ❌ | ❌ | ❌ | A themed minimod that adds some japanese and chinese-themed stuff to the game. |
| Thorium Content Pack (broken) | DivermanSam (broken) | 0.34.0 | ❌ | ❌ | ❌ | ❌ | Adds a wide variety of items, armor, weapons and NPCs. |
| Buildaria-like mod (broken) | Duze (broken) | 0.33.0 | ❌ | ❌ | ❌ | ❌ | Features selecting/replacing only specific tile/wall types, as well as most Buildaria features. Rebuild to any tConfig version (if nothing major changes, everything contained in Initialize and UpdatePlayer hooks) |
...
| Legend of Sapharan (broken) | Sapharan (broken) | 0.29.9 | ❌ | ❌ | ❌ | ❌ | Legend of Sapharan, Act 1. The Eyes Adds some items, ores and mobs. Mod mainly focuses on adding more variety to the game. |
| Nyra's Mod Pack (broken) | Nyra Stiel (broken) | 0.29.6 | ❌ | ❌ | ❌ | ❌ | Adds a wide variety of items that for the most part have nothing to do with each other. |
| Daft Punk - Guy-Man's Helmet (broken) | Xargon (broken) | 0.29.3 | ❌ | ❌ | ❌ | ❌ | Guy-Manuel's Helmet as a vanity helm. |
| Doctor Who Mod (broken) | SonicR (broken) | 0.29.2 | ❌ | ❌ | ❌ | ❌ | A Doctor Who themed mod that adds a variety of weapons, NPCs and items. Includes new worlds and an optional species system. |
| Dark Souls Mod (broken) | Tim Hjersted (broken) | 0.29.1 | ❌ | ❌ | ❌ | ❌ | A massive community mod with extensive remixing and unique features designed around the 15-30 hour Story of Red Cloud Adventure map. |
| RussLeeIV's Mods (broken) | RussLeeIV (broken) | 0.29.1 | ❌ | ❌ | ❌ | ❌ | Several mods including Equipment, Building Tools, Tiles, Additional Player Storage and Interface and Functionality changes. |
| The Hellish Hardmode (broken) | Bullseye55 (broken) | 0.29.0 | ❌ | ❌ | ❌ | ❌ | Aims to rebalance Terraria by adding player-suggested ideas from the Suggestions forum, as well as testing new Tconfig features. Release 7 is out! Requires W1K's Hunger System. Merging with Avalon soon. Will provide a much better experience for you, and my team. :P |
...
| Knight's Trenchcoats and Katanas (broken) | Knight9910 (broken) | 0.28.5 | ❌ | ❌ | ❌ | ❌ | Exactly what the name implies, it's a bunch of vanity trenchcoats and katana-type weapons. |
| Magia Machina (broken) | Revos (broken) | 0.28.5 | ❌ | ❌ | ❌ | ❌ | A mix of Steampunk and cartoonish dark fantasy. I strive to add unique elemets that set my mod apart from your run of the mill Copy/Paste mod. |
| Bags of Holding (broken) | Lycos Hayes (broken) | 0.28.5 | ❌ | ❌ | ❌ | ❌ | A set of player-storage items that gives you a larger inventory while exploring. |
| Lycos Hayes' Vanity Flair Kit (broken) | Lycos Hayes (broken) | 0.28.5 | ❌ | ❌ | ❌ | ❌ | A kit of vanity items, both for the player and the world. This kit includes custom glass walls. Also includes download for Lawura's Builder Pack, updated to current version. |
| Tunnel King's Mods (broken) | Tunnel King (broken) | 0.28.5 | ❌ | ❌ | ❌ | ❌ | Meteor Barriers to protect your world/base, a Portable Meteor Biome, other small mods to come. |
| Drills and Tools (broken) | GiSS588 (broken) | 0.28.2 | ❌ | ❌ | ❌ | ❌ | A lot of useful tools and drills |
| Symple Terraria (broken) | Symple (broken) | 0.28.2 | ❌ | ❌ | ❌ | ❌ | Adds over 170 new items, new mechanics, and faction based pvp. |
| Weapon/Accessory Modifier Pack (broken) | rangerofthewest (broken) | 0.28.2 | ❌ | ❌ | ❌ | ❌ | A whole bunch of new prefixes/suffixes for players to enjoy! |
| Alchemy Mod (broken) | [Deadwindshadow](https://steamcommunity.com/id/jimmyl) | 0.28.2 | ❌ | ❌ | ❌ | ❌ | Adds potions that make you mine faster or turn you into stone! Includes readme on how to craft items inside the pack. Adds over 45 new items and over 12 new buffs! |
| SYNTAX'S MOD (broken) | SYNTAX (broken) | 0.28.1 | ❌ | ❌ | ❌ | ❌ | Adds lots of items to the game focusing on the lower level items. |
| The Legend of Terraria (broken) | MiraiMai (broken) | 0.28.0 | ❌ | ❌ | ❌ | ❌ | Inspired by 'The Legend of Zelda', this modpack aims to give all fans some much needed content to go with their green Hero's outfit. Currently contains: The Rupee Mod. Planned: Hero's Swords, Hero's Tools, The Masks Mod, The Minish Mod |
| Dynamic Difficulty Adjustment (broken) | Arkhalis (broken) | 0.27.2 | ❌ | ❌ | ❌ | ❌ | Increases the difficulty of NPC's based on the number of players on your server. Also, the Difficulty Adjuster item can be used to increase difficulty in single player, or simulate extra players in multiplayer! |
| [Jewelcrafting Mod](https://www.dropbox.com/scl/fi/brt8sfl7nm04vmdq5sm4b/Jewelcrafting-Mod.zip?rlkey=mvc71qaqswka5qcmc5v6n2g9o&e=1) | [Deadwindshadow](https://steamcommunity.com/id/jimmyl) | 0.27.2 | ✅ | ❌ | ❌ | ✅ | Adds jewels, new exciting materials, and rings that offer powerful stat upgrades. Ex: +15% Run Speed. Includes readme on how to craft items in the pack. |
| Never Enough Devices! (broken) | MiraiMai (broken) | 0.27.2 | ❌ | ❌ | ❌ | ❌ |
| Never Enough Mods! (broken) | MiraiMai (broken) | 0.27.2 | ❌ | ❌ | ❌ | ❌ |
| Metroid Mod (broken) | scooterboot9697 (broken) | 0.27.2 | ❌ | ❌ | ❌ | ❌ |
| WW2 Weapons Pack (broken) | Shadow123 (broken) | 0.27.2 | ❌ | ❌ | ❌ | ❌ |
| Hesperides Temple (broken) | Excitement (broken) | 0.27.1 | ❌ | ❌ | ❌ | ❌ |
| Omnir's Modpacks (broken) | Omnir (broken) | 0.27.1 | ❌ | ❌ | ❌ | ❌ |
| Portal Mod (Temphix) | Temphix | 0.27.0 | ❌ | ❌ | ❌ | ❌ |
| Cobalt Mod (broken) | Blessed (broken) | 0.24.0 | ❌ | ❌ | ❌ | ❌ |
| Plexiglass (broken) | eliure (broken) | 0.24.0 | ❌ | ❌ | ❌ | ❌ |
| mbran's modpack (broken) | mbran139 (broken) | 0.24.0 | ❌ | ❌ | ❌ | ❌ |
| Mainslot-0 (broken) | MiraiMai (broken) | 0.24.0 | ❌ | ❌ | ❌ | ❌ |
| New Terraria Mod (broken) | Nawe^^ (broken) | 0.24.0 | ❌ | ❌ | ❌ | ❌ |
...
| Eggs! (broken) | Classikly (broken) | 0.23.3 | ❌ | ❌ | ❌ | ❌ |
| Flag Mode (broken) | Light Sparkle (broken) | 0.23.3 | ❌ | ❌ | ❌ | ❌ |
| JMod (Joshua Searle) (broken) | Joshua Searle (broken) | 0.23.3 | ❌ | ❌ | ❌ | ❌ |
| Katanas+ (broken) | Fish Bowl (broken) | 0.23.3 | ❌ | ❌ | ❌ | ❌ |
| Platinum Gear (broken) | Classikly (broken) | 0.23.3 | ❌ | ❌ | ❌ | ❌ |
| Poison Mod (broken) | Party_Poison (broken) | 0.23.3 | ❌ | ❌ | ❌ | ❌ |
| Sigia's Mod (broken) | Sigia (broken) | 0.23.3 | ❌ | ❌ | ❌ | ❌ |
| Silpm Mod (broken) | Silpm (broken) | 0.23.3 | ❌ | ❌ | ❌ | ❌ |
| Terraria Avalon (broken) | blahblahbal (broken) | 0.23.3 | ❌ | ❌ | ❌ | ❌ |
| Kjulo's DLC (broken) | Kjulo (broken) | 0.23.1 | ❌ | ❌ | ❌ | ❌ |
| Weird Weapon Mod (broken) | SpyStone (broken) | 0.23.1 | ❌ | ❌ | ❌ | ❌ |
| Other Worlds (broken) | Dogsonofawolf (broken) | 0.22.3 | ❌ | ❌ | ❌ | ❌ |
...
| Kjulo's Dlc (broken) | Kjulo (broken) | 0.26.2 | ❌ | ❌ | ❌ | ❌ |
| Greater Healing Potion (broken) | Catlover341 (broken) | ??? | ❌ | ❌ | ❌ | ❌ |
| Amber Staff (broken) | Crimsonthorn (broken) | ??? | ❌ | ❌ | ❌ | ❌ |
| Day Orb (broken) | Crimsonthorn (broken) | ??? | ❌ | ❌ | ❌ | ❌ |
| Kasudain's Arsenal (broken) | Kasudain (broken) | ??? | ❌ | ❌ | ❌ | ❌ |
| [Lawura's Builder Pack](https://tconfig.fandom.com/wiki/Lawura%27s_Builder_Pack) | Lawura (broken) | ??? | ❌ |  ❌ | ❌ | ❌ |
| Weapon & Tools Overhaul (broken) | MrNewGuy (broken) | ??? | ❌ | ❌ | ❌ | ❌ |
| [Obsidian Sword](https://www.mediafire.com/file/kw51c2o7w5bqlpw/Obsidian+Sword.zip) | Serlan (broken) | ??? |  ✅ | ❌ | ❌ | ✅ |
...
| Teleportation (broken) | ??? | 0.25.2 | ❌ | ❌ | ❌ | ❌ |
| Sagittarius Sword (broken) | ??? | 0.27.3 | ❌ | ❌ | ❌ | ❌ |
| Cosmic Crown (broken) | ??? | 0.27.3 | ❌ | ❌ | ❌ | ❌ |
| [Portal Mod](https://www.mediafire.com/file/rgg67tqbsp664it/Portal%20Mod.zip) | Temphix (broken) | 0.27.0 | ✅ |  ❌ |❌ | ✅ |
| Sword Pack (broken) | Offline (broken) | ??? | ❌ | ❌ | ❌ | ❌ |
| VarietyPak (broken) | NeonJ (broken) | 0.26.4 | ❌ | ❌ | ❌ | ❌ |
| Kjulos Mod (1.0 Beta) (broken) | Kjulo (broken) | ??? | ❌ | ❌ | ❌ | ❌ |
| SonnyMod (broken) | Sonny (broken) | ??? | ❌ | ❌ | ❌ | ❌ |